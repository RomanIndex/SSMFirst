<#assign buList = ["艾欧尼亚", "祖安", "如瑞玛", "诺克萨斯", "德玛西亚", "暗影岛"]>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <form id="formId" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="mobile" value="${object.mobile}"
                                       placeholder="电话">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea class="form-control" id="remark" name="remark"
                                          placeholder="备注说明限200字！"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text"
                                       onkeyup="this.value=this.value.replace(/\D/g,'').replace(/\b[0]/g,'')"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input id="pictureFile" style="display: none;" type="file" name="pictureFile"
                                       onchange="pictureApi.getFullPath(this)"/>
